...
Refinery::Pages.configure do |config|
  ...
  config.default_parts = ["Body", "Side Body", "inSide Body"]
  ...
  # config.page_title = {:page_title=>{:wrap_if_not_chained=>false, :class=>nil, :tag=>nil}, :ancestors=>{:class=>"ancestors", :separator=>" | ", :tag=>"span"}, :chain_page_title=>false}
